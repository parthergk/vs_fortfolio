  ...
  return (
    <div className=" bg-customBlackSec w-full grid grid-cols-1 md:grid-cols-2 gap-7 md:gap-5 p-3 ">
      ...
      <div className="flex justify-center items-center row-span-2 relative">
        <div className=" w-48 h-60 md:w-64 md:h-96  relative md:-left-4 -left-2 bottom-2 md:bottom-4 z-10 bg-neutral-500 cursor-pointer transition-all duration-300 hover:shadow-lg hover:shadow-purple-500"></div>
        <div className="w-48 h-60 md:w-64 md:h-96 border-2 absolute "></div>
      </div>
